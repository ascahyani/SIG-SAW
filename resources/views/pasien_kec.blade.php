...
<script>
    ...
    $('.kec').click(function(){
        var kecaa = {};
        $('.kec:checked').each(function(){
            if($(this).is(":checked")){
                kecaa[$(this).attr('name')]=$(this).val();
            }
        });
                                        ...
                                        <div class="form-group row">
                                            ...
                                            @foreach($namkec as $nama)
                                                <div class="form-group form-check">
                                                    <input type="checkbox" class="kec" id="kecamatan" name="kecamatan" value="{{$nama->id}}">
                                                    <label class="form-check-label" for="exampleCheck1">{{$nama->nama_kecamatan}}</label>
                                                </div>
                                            @endforeach

                                            </form>
                                            
                                                <div class="row updateDiv" id="updateDiv">
